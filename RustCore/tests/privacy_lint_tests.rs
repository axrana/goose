...
fn assert_rule(report: &goosecore::privacy_lint::PrivacyLintReport, rule: &str) {
    assert!(
        report
            .files
            .iter()
...
fn assert_next_action(report: &goosecore::privacy_lint::PrivacyLintReport, reason: &str) {
    assert!(
        report
            .next_actions
            .iter()
