...
fn sleep_v1_release_gate_validation_passes_only_when_all_evidence_reports_pass() {
    ...
    assert_eq!(
        report
            ...
            .and_then(serde_json::Value::as_str),
        Some(goosecore::historical_sync::HISTORICAL_SYNC_PHYSICAL_REPORT_INTEGRITY_POLICY)
    );
    assert_eq!(
        report
            .provenance
    ...
    assert_eq!(
        report
            ...
            .and_then(|policies| policies.get("sleep-v1-benchmark.json"))
            .and_then(serde_json::Value::as_str),
        Some(goosecore::algorithm_compare::SLEEP_V1_BENCHMARK_COMPARISON_POLICY)
    );
    ...
    forged_physical
        .next_actions
        .push(goosecore::historical_sync::HistoricalSyncNextAction {
    ...
    forged_window.next_actions.push(
        goosecore::sleep_validation::SleepWindowLabelValidationNextAction {
    ...
    forged_stability.next_actions.push(
        goosecore::sleep_validation::SleepV1ExplanationStabilityNextAction {
    ...
    forged_benchmark.next_actions.push(
        goosecore::algorithm_compare::AlgorithmComparisonNextAction {
...
fn sleep_v1_evidence_folder_validation_rejects_hand_edited_release_gate_report_counts() {
    ...
    release_report
        .next_actions
        .push(goosecore::sleep_validation::SleepV1ReleaseGateNextAction {
...
fn sleep_stage_label_validation_compares_user_owned_stage_labels() {
    ...
    assert_eq!(
        ...
        serde_json::json!(goosecore::sleep_validation::SLEEP_STAGE_LABEL_REPORT_INTEGRITY_POLICY)
    );
    assert!(
        report
            .comparisons
